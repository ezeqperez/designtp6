...
@Entity
@DiscriminatorValue(value="MayorIgual")
public class CondicionMayorIgual extends CondicionInterface {
	...
	public CondicionMayorIgual() {
	}
	
	public CondicionMayorIgual(IndicadorInterface p_indicadorIzquierda, IndicadorInterface p_indicadorDerecha) {
