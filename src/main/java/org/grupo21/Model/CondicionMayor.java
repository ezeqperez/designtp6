...
@Entity
@DiscriminatorValue(value="Mayor")
public class CondicionMayor extends CondicionInterface {
	...
	public CondicionMayor(IndicadorInterface p_indicadorIzquierda, IndicadorInterface p_indicadorDerecha) {
